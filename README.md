...
| MAX_DOCUMENTS_UPLOAD              | 2mb                                                                                            | Set the maximum combined size for document upload (in bytes when no postfix is given, else append either 'kb', 'mb' or 'gb'); need to be set accordingly in the backend. |
