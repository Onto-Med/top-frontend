export default {
  ...
  ageRestrictionDescription:
    'Set one or more age restrictions for this phenotype. Values are in years.',
  aggregationFunction: 'Aggregation function|Aggregation functions',
  aggregationFunctionDescription:
    'This is a composite phenotype, which means that a default aggregation function is required for cases where no function is explicitly given in the expression of a phenotype. Aggregation functions are needed to aggregate multiple phenotype values to one value and to be able to use it for calculations.',
  and: 'and',
  asc: 'Ascending',
  back: 'Back',
  ...
  dateTimeRestrictionDescription:
    'Restrict the time range, when this phenotype must have been observed.',
  ...
  eligibilityCriterionSelection:
    'Click on phenotypes in the left tree to add them to the criteria list.',
  entityIsForkDescription: 'This entity has been forked from an entity in another repository.',
  exclusion: 'Exclusion|Exclusions',
  execute: 'Execute',
  export: 'Export',
  exportDescription:
    'Select a format in which you want to create an export for the selected content.',
  ...
  queryImportDescription:
    'Alternatively, you can re-import a previously exported query using the form below.',
  ...
  primaryRepositoryDescription:
    'Public repositories are readable by everyone. Their content can be forked into private repositories and they support pull requests.',
  reload: 'Reload',
  dismiss: 'Dismiss',
  notFound: 'Not found',
  ...
  thingStopped: '{thing} has been stopped',
  ...
  entityEditor: {
    ...
    titlesHelp:
      'You can enter exactly one title per language. The titles should be short and comprehensible. When displaying an entity, the title appropriate for the current language setting is selected. If no suitable title is specified for the language setting, the first entry in the list is used.',
    synonymsHelp:
      'Synonyms are alternative names for entities. For example, the phenotype "BMI" could have the synonym "Body Mass Index".',
    descriptionsHelp:
      'Here you can specify further descriptions or definitions of the entity in different languages.',
    codesHelp:
      'In this section, specify links to taxonomies (e.g. SNOMED CT) so that the phenotype is mapped to the standards and can be linked to other IT systems. In this way, on the one hand, data from other sources can be read in and used for phenotyping. On the other hand, results can be fed back to external IT systems. Just type in a code or code title to start the search. You can optionally filter by code system.',
    formulaHelp:
      'Mathematical and Boolean formulas can be entered here to calculate the values of the phenotype. Formulas can contain other phenotypes as well as constants.',
    textFormulaHelp:
      'Concepts can be connected here via Boolean variables or fuzzy matching defined.',
    restrictionHelp:
    ...
    delete: {
      confirm:
        'Do you really want to delete the entity irrevocably? All saved versions and restrictions will also be deleted.',
      cascade: 'Delete contained entities as well.',
    },
  },
  organisationPage: {
    description:
      'The content of the {productName} is structured into organisations. Bundle models into an organisation if you want them to have the same access rights. You can invite other users to your organisations by giving them read, write, or manage rights. All available organisations are listed below. The icons on the left indicate your access rights.',
  ...
  documentSearch: {
    ...
    description: 'Please select a data source you want to search for documents.',
  },
  ...
  itemType: {
    ...
    description:
      'Item types are used to further describe a phenotype and its assignment to an individual. They can only be defined for single phenotypes, as these phenotypes are directly linked to the underlying data elements. Depending on the data source, data retrieval can differ dramatically between item types.',
  },
  itemTypes: {
  ...
  itemTypeDescriptions: {
    ...
    clinical_impression:
      "A record of a clinical assessment performed to determine what problem(s) may affect the patient and before planning the treatments that is best to manage a patient's condition.",
    condition:
      'A clinical condition, problem, diagnosis, or other event, situation, issue, or clinical concept that has risen to a level of concern.',
    medication_administration:
      'Describes the event of an individual consuming or otherwise being administered a medication.',
    medication_request:
    ...
    procedure:
      'An action that is or was performed on or for an individual. This can be a physical intervention, counselling, or other services.',
    subject_age:
      'The phenotype class for the age of a subject may require special handling when accessing data sources and must therefore be marked separately.',
    subject_birth_date:
      'The phenotype class for the birth date of a subject may require special handling when accessing data sources and must therefore be marked separately.',
    subject_sex:
      'The phenotype class for the sex of a subject may require special handling when accessing data sources and must therefore be marked separately.',
  },
  ...
  importDescription:
    "Select a file and the respective format to upload it's content to the this repository.",
  ...
  confirmChangeExpressionType:
    'If you change the expression type, any data already entered will be lost.\nDo you want to continue?',
  ...
  confirmDeleteOrganisationMembership:
    'Are you sure you want to delete this membership? The user will lose their permissions for this organisation!',
  add: 'Add',
  editAccount: 'Edit account',
  resultCountWithTotal: 'No results|{count} of {total} result|{count} of {total} results',
  appDescription:
    'This framework supports the modelling and application of phenotypes. It also enables ontology-based document search.',
  ...
  includePrimaryRepositoriesDescription:
    'Check this option to expand the entity search to all entities in public repositories.',
  forkCouldNotBeCreated:
    'A fork could not be created because there may already be an up-to-date fork in this repository.',
  previousQuery: 'Previous query|Previous queries',
  result: 'Result',
  queued: 'Queued',
  notAuthorised: {
    onlyPrimaryVisible:
      'You do not have required permissions, so only public repositories are visible to you.',
  },
  boolean: 'Boolean',
  codeInput: {
    allCodeSystems: 'all',
  ...
  gdprNotice:
    '{productName} uses technically necessary cookies that are required for basic functionalities and thus enable the operation of the application.',
  accept: 'Accept',
  ...
  entitySearchDescription:
    'Search for entities by entering text and/or using the filter options above.',
  greeting: 'Welcome to the {productName}!',
  home_: {
    createModels: {
      header: 'Create a Model|Create Models',
      content:
        'Create phenotype definitions in a standardised way and combine them to complex models. Models can be used to run queries or integrate with other software. In addition to phenotypes, you can also create models of concepts to apply them to medical documents.',
    },
    runQuery: {
      header: 'Run a Query|Run Queries',
      content:
        'Build queries based on models to search for individuals or medical documents in connected data sources, such as health data stores.',
    },
    content: {
  ...
  queryBuilder: {
    description:
      'You first need to select the phenotype model that you want to use and a data source to perform the query on. You can then use the model content to specify the query criteria and output.',
  },
  repositoryContainingModel: 'Repository containing the model',
  confirmClearQuery:
    'If you switch to another repository, your current query will be lost. Are you sure?',
  ...
  terminologyImport: {
    ...
    description:
      'Please select a code from the terminology server with the form above. The resulting entity will be displayed here.',
  },
  withRestriction: 'With restriction|With restrictions',
  entityImported:
    'No entities were imported|One entity has been imported|{count} entities have been imported',
  ...
  confirmRemoveDataSource: 'Do you really want to remove this data source?',
  thingRemoved: '{thing} has been removed',
  suitableFor: 'Suitable for',
  manageDataSourceDescription:
    'Select a data source that you want to make available to this organisation. All users with write permission will be able to query this source.',
  recordsPerPage: 'Records per page:',
  of: 'of',
  manage: 'Manage',
  edit: 'Edit',
  '404Description': 'The requested page does not exist.',
  concept_cluster: 'Concept cluster|Concept clusters',
  ...
  codeMissingDescription:
    'It is recommended to provide at least one code to ensure the reusability of this model.',
  codeImport: {
    title: 'Code import from CSV',
    imported: 'One Code accepted|{count} codes accepted',
    fileDescription:
      'Select a CSV file containing codes. The file should have two or three columns, one for the code system URI, one for the code and optionally one for the scope.',
    selectCodesToImport:
      'In the table below, select the codes you wish to transfer from the CSV file. You can modify the table entries as required by clicking on a row.',
    selectFile: 'Select CSV file',
    hasHeader: 'Has header row',
    failed: 'An error occured during the code import.',
  },
  codeScope: {
    title: 'Scope',
  ...
  confirmUnsavedChanges:
    'There are unsaved changes that will be lost when you leave this page. Proceed anyway?',
  ...
  emptyQueryOutput:
    'By default, all phenotypes required to calculate the query result are automatically included in the output. You can specify additional phenotypes to be included here.',
  frontend: 'Frontend|Frontends',
  backendUnavailable: 'The backend server is currently not available. Please try again later.',
  backend: 'Backend|Backends',
  showGrid: 'Show data table',
  unavailable: 'unavailable',
  tryAgain: 'Try again',
  dataOfQuery: "Data of query '{thing}'",
  fileToDisplay: 'File to display|Files to display',
  definition: 'Definition|Definitions',
  conceptCluster: {
    noConceptsAvailable:
      'No concepts are currently available. They may need to be generated from a text corpus first. Please use the button above to start the generation process.',
    selectConceptsDescription:
      'On the right-hand side of the page, please specify the concepts you would like to use to search for documents.',
    regenerate: 'Regenerate',
    confirmRegenerate:
      'Do you really want to regenerate the concept clusters? The process will take a few minutes, depending on the size of the corpus, and previous clusters will be dropped.',
    pipelineStarted:
      'The generation pipeline has been started. In a few minutes, new clusters should be available.',
    pipelineFailed: 'The generation pipeline has failed. Please try again.',
    reviewDescription:
      'Please select relevant clusters from the pre-processing below, and you can then choose to publish them so that they are available for document queries.',
    preProcessingDescription:
      "In order to generate concept clusters for a data source, the documents contained in that data source must be pre-processed using a concept graph pipeline. Depending on the number of documents, this pipeline can take several minutes or up to a couple of hours and it's status is listed below. There can only be one pipeline for a data source, which means that restarting the pipeline will delete all existing concept clusters!\nOnce the pre-processing is complete, you can navigate to the next step and select relevant clusters to make available to users for document retrieval.",
    confirmStart:
      'Starting the pre-processing pipeline will delete any existing concept clusters for this data source. Do you want to continue?',
    confirmDelete:
      'Do you really want to delete this pipeline and all the concept clusters derived from this data source?',
    confirmPublish:
      'Publishing the selected concept clusters will remove all previously published clusters. Do you want to continue?',
    configurationGetError:
      "Couldn't find configuration: Please refer to the `concept-graphs-api` documentation (https://github.com/Onto-Med/concept-graphs/blob/67a8f9b44029a5dfa7d5a5b4fa4f19263336a426/README.md) on how to write your own.\nElse default values will be used.",
    configurationGetSavedWarning: 'Using saved configuration from last edit.',
    configurationGetDefaultWarning: 'Showing default configuration file ({lang}).',
    configurationGetCurrentPipelineWarning: 'Showing configuration the pipeline was run with.',
    confirmStop:
      'Do you really want to stop the pipeline? If so, you can skip the steps that were already successfully done later.',
    skipPresent: 'Skip already successfully run steps?',
    tooltips: {
      noLanguage: 'You have to choose a language first before you are allowed',
      onlyAdmins: 'Only administrators are allowed',
      running: '{optional}seems to be running',
      stopped: '{optional}is in the process of being stopped',
      editing: "to edit a pipeline's configuration.",
      starting: 'to start a pipeline.',
      cantStart: "You can't start a new one for this data source at the moment.",
      cantEdit: "You can't edit its configuration now.",
    },
  },
  pipelineManagementOfDataSource: "Pipeline management of data source '{dataSource}'",
  configurationOfPipeline: 'Pipeline configuration',
  clusterReview: 'Cluster review|Cluster reviews',
  preProcessing: 'Pre-processing',
  status: 'Status',
  pipeline: 'Pipeline|Pipelines',
  startThing: 'Start {thing}',
  finish: 'Finish',
  continue: 'Continue',
  successful: 'Successful',
  stopped: 'Stopping',
  label: 'Label|Labels',
  publishThing: 'Publish {thing}',
  node: 'Node|Nodes',
  edge: 'Edge|Edges',
  quoteThing: "'{thing}'",
  phrase: 'Phrase|Phrases',
  errorLoadingData: 'Could not load {type} data from the server.',
  uploadDataSource:
    'Alternatively, you can upload a file to create a data source for test purposes.',
  create: 'Create',
  upload: 'Upload',
  file: 'File|Files',
  type: 'Type|Types',
  dataSourceFileTypes: {
    csv_encounter: 'CSV (encounter)',
    csv_subject: 'CSV (subject)',
    csv_subject_resource: 'CSV (subject resource)',
    fhir: 'HL7 FHIR',
  },
  dataSourceFileTypeDescriptions: {
    csv_encounter: 'Table header row: encounterId;subjectId;type;startDateTime;endDateTime',
    csv_subject: 'Table header row: subjectId;birthDate;sex',
    csv_subject_resource:
      'Table header row: subjectResourceId;encounterId;subjectId;codeSystem;code;dateTime;startDateTime;endDateTime;unit;numberValue;textValue;booleanValue;dateTimeValue\nOnly one of the value columns needs to be filled according to the data type.',
    fhir: 'An HL7 FHIR bundle consisting of patient, encounter and observation resources.',
  },
  startedThing: '{thing} started.',
  dataSourceId: 'Data source ID|Data source IDs',
  finishedThing: 'Finished {thing}.',
  mergeEncounters: 'Merge encounter resources',
}
