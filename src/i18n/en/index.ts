export default {
  ...
  'medication_request.description': 'An order or request for both supply of the medication and the instructions for administration of the medication to a patient.',
  medication_statement: 'Medication statement|Medication statements',
  'medication_statement.description': 'A record of a medication that is being consumed by an individual.',
  minimum: 'Minimum',
  nothingSelectedYet: 'Nothing has been selected yet.',
  observation: 'Observation|Observations',
  'observation.description': 'Measurements and simple assertions made about an individual.',
  performThing: 'Perform {thing}',
  pleaseModifySettings: 'Please modify the settings',
  procedure: 'Procedure|Procedures',
  'procedure.description': 'An action that is or was performed on or for an individual. This can be a physical intervention, counseling, or other services.',
  ...
  'condition.description': 'A clinical condition, problem, diagnosis, or other event, situation, issue, or clinical concept that has risen to a level of concern.',
