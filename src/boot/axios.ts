...
export const ConceptgraphsApiKey: InjectionKey<ConceptgraphsApi> = Symbol('conceptgraphsApi')
...
export default boot(({ app }) => {
  ...
  app.provide(ConceptgraphsApiKey, new ConceptgraphsApi(undefined, '', axiosInstance))
